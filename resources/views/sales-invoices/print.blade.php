...
<head>
    ...
    <style>
        * {
        ...
        .client-table-row1 th:nth-child(1) {
            width: 15%;
        }

        .client-table-row1 th:nth-child(2) {
            width: 15%;
        }

        .client-table-row1 th:nth-child(3) {
            width: 40%;
        }

        .client-table-row1 th:nth-child(4) {
            width: 15%;
        }
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="header-center">
                ...
                <h2 style="margin-top: -10px;">Sales Invoice - Tax Invoice</h2>
                <h2 style="font-size: 20px; margin-top: 2px;">فاتورة مبيعات - فاتورة ضريبية</h2>
            </div>
        ...
        <table class="client-table-row1">
            <tr>
                <th>
                    <div class="bilingual">
                        <div class="ar">رقم ضريبة القيمة المضافة</div>
                        <div class="en">VAT Number</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">رقم السجل التجاري</div>
                        <div class="en">Commercial Registration No</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">اسم المشتري</div>
                        <div class="en">Buyer Name</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">رمز العميل</div>
                        <div class="en">Customer Code</div>
                    </div>
                </th>
            </tr>
            <tr>
        ...
        <table class="client-table">
            <tr>
                <th>
                    <div class="bilingual">
                        <div class="ar">الرمز البريدي</div>
                        <div class="en">Postal Code</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">الدولة</div>
                        <div class="en">Country</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">المدينة</div>
                        <div class="en">City</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">الحي</div>
                        <div class="en">District</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">الرقم الفرعي</div>
                        <div class="en">Secondary No</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">الشارع</div>
                        <div class="en">Street</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">رقم المبنى</div>
                        <div class="en">Building No</div>
                    </div>
                </th>
            </tr>
            <tr>
        ...
        <table class="invoice-details-table">
            <tr>
                <th>
                    <div class="bilingual">
                        <div class="ar">طريقة/شروط الدفع</div>
                        <div class="en">Mode/Terms of Payment</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">مكان التوريد</div>
                        <div class="en">Place of Supply</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">تاريخ التسليم</div>
                        <div class="en">Delivery Date</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">رقم التسليم</div>
                        <div class="en">Delivery No</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">رقم أمر الشراء</div>
                        <div class="en">Buyers Order No.</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">رقم الفاتورة</div>
                        <div class="en">Invoice No</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">التاريخ والوقت</div>
            ...
            <tr>
                ...
                <td></td>
                <td>{{ $salesInvoice->deliveryDocument->date_and_time ? \Carbon\Carbon::parse($salesInvoice->deliveryDocument->date_and_time)->format('Y/m/d') : '' }}
                </td>
                <td>{{ $salesInvoice->deliveryDocument->document_number ?? 'DEL-' . $salesInvoice->delivery_document_id }}
                </td>
        ...
        <table class="items-table">
            <thead>
                <tr>
                    <th>
                        <div class="bilingual">
                            <div class="ar">الرقم التسلسلي</div>
                            <div class="en">Serial No</div>
                        </div>
                    </th>
                    <th>
                        <div class="bilingual">
                            <div class="ar">وصف البضائع</div>
                            <div class="en">Description of Goods</div>
                        </div>
                    </th>
                    <th>
                        <div class="bilingual">
                    ...
                    <th>
                        <div class="bilingual">
                            <div class="ar">السعر الوحدة</div>
                            <div class="en">Unit price</div>
                        </div>
                    </th>
                    <th>
                        <div class="bilingual">
                            <div class="ar">إجمالي المبلغ غير شامل الضريبة</div>
                            <div class="en">Subtotal Exclusive of VAT</div>
                        </div>
                    </th>
                    <th>
                        <div class="bilingual">
                            <div class="ar">نسبة الضريبة</div>
                            <div class="en">VAT Rate</div>
                        </div>
                    </th>
                    <th>
                        <div class="bilingual">
                            <div class="ar">مبلغ الضريبة</div>
                            <div class="en">VAT Amount</div>
                        </div>
                    </th>
                    <th>
                        <div class="bilingual">
                            <div class="ar">إجمالي المبلغ شامل الضريبة</div>
                            <div class="en">Subtotal Inclusive of VAT</div>
                        </div>
                    </th>
                </tr>
            </thead>
        ...
        <table class="totals-table">
            <tr>
                <td class="label">
                    <div class="bilingual">
                        <div class="ar">إجمالي المبلغ (غير شامل الضريبة)</div>
                        <div class="en">Total (Exclusive VAT)</div>
                    </div>
                </td>
            ...
            <tr>
                <td class="label">
                    <div class="bilingual">
                        ...
                        <div class="en">VAT Total Amount</div>
                    </div>
                </td>
            ...
            <tr>
                <td class="label total">
                    <div class="bilingual">
                        <div class="ar">إجمالي المبلغ (شامل الضريبة)</div>
                        <div class="en">Invoice Gross (Inclusive VAT)</div>
                    </div>
                </td>
                <td class="value total" colspan="2">
                    {{ number_format($salesInvoice->total_amount ?? ($subtotal + $totalTax - ($salesInvoice->discount_amount ?? 0)), 2) }}
                </td>
            </tr>
        </table>
        ...
        <table class="signature-table">
            <tr>
                <td colspan="3" style="text-align: center;"><strong>Customer Seal and Signature</strong><br>ختم وتوقيع
                    العميل</td>
                <td colspan="3" style="text-align: center;"><strong>Netaj Almotatwrah Commercial Co.</strong><br>شركة
                    نتاج المتطورة التجارية<br><strong>Authorised Signatory</strong> المفوض بالتوقيع</td>
            </tr>
        </table>
    </div>
</body>
