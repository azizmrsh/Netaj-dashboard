...
<head>
    ...
    <style>
        * {
        ...
        .supplier-table-row1 th:nth-child(1) {
            width: 15%;
        }

        .supplier-table-row1 th:nth-child(2) {
            width: 15%;
        }

        .supplier-table-row1 th:nth-child(3) {
            width: 55%;
        }

        .supplier-table-row1 th:nth-child(4) {
            width: 15%;
        }
    ...
    <div class="container">
            ...
            <tr>
                ...
                <th>
                    <div class="bilingual">
                        ...
                        <div class="en">Commercial Registration number</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">إسم المورد</div>
                        <div class="en">Supplier Name</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">رمز المورد</div>
                        <div class="en">Supplier Code</div>
                    </div>
                </th>
            </tr>
            <tr>
        ...
        <table class="invoice-details-table">
            <tr>
                <th>
                    <div class="bilingual">
                        <div class="ar">طريقة / شروط السداد</div>
                        <div class="en">Mode/Terms of Payment</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">الملاحظات</div>
                        <div class="en">Notes</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">تكاليف إضافية</div>
                        <div class="en">Additional costs</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">الشحن</div>
                        <div class="en">shipping</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
                        <div class="ar">الرقم المرجعي / المشتري</div>
                        <div class="en">Reference number /buyer</div>
                    </div>
                </th>
                <th>
                    <div class="bilingual">
        ...
        <table class="totals-table">
            ...
            <tr>
                ...
                <td class="value" colspan="2">{{ number_format($purchaseInvoice->total_tax_amount ?? $totalTax, 2) }}
                </td>
            </tr>
            <tr>
                <td class="label total">
                    <div class="bilingual">
                        <div class="ar">إجمالي المبلغ (شامل الضريبة القيمة المضافة)</div>
